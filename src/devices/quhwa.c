...
r_device quhwa = {
    ...
    .short_width   = 360,  // Pulse: Short 360탎, Long 1070탎
    .long_width    = 1070, // Gaps: Short 360탎, Long 1070탎
    .reset_limit   = 6600, // Intermessage Gap 6500탎
    .gap_limit     = 1200, // Long Gap 1120탎
