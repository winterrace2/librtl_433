...
static int acurite_rain_896_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
...
*/
static int acurite_th_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
    uint8_t *bb = NULL;
...
*/
static int acurite_txr_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
    int browlen, valid = 0;
    uint8_t *bb;
...
*/
static int acurite_986_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
    int const browlen = 5;
...
static int acurite_606_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
    data_t *data;
    uint8_t *b;
    int row;
...
static int acurite_00275rm_decode(r_device *decoder, bitbuffer_t *bitbuffer, extdata_t *ext)
{
